...
def main():
	...
	# Load file
	df = pd.read_csv('https://github.com/Teemmii/Customer-Churn-App/blob/c6bbd28a85efd7dd8183f6b85571db143fb0edb9/BankChurners3.CSV', header=None,error_bad_lines=False)
	#EDA
	if choice == 'EDA':
