...
def main():
	...
	# Load file
	df = pd.read_csv('https://github.com/Teemmii/Customer-Churn-App/blob/ba4d1b4cf418d48e887d7f69edcd85fc13c09316/BankChurners3.CSV', header=None, error_bad_lines=False)
	#EDA
	if choice == 'EDA':
	...
	#Ml mapping
		...
		if st.checkbox("Make Prediction"):
			...
			model_predictor = load_prediction_model ("model.pkl")
			#loaded_model = ("//TEEMMII/Users/temio/Documents/Data_Science/Projects/CreditCard-Users-Churn-Prediction-main/streamlit_version/model.pkl")
