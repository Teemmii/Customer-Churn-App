...
def main():
	...
	# Load file
	df = pd.read_csv('https://github.com/Teemmii/Customer-Churn-App/blob/db6915649127600864423ceb0871c17d9b214808/BankChurners3.csv', header=None,error_bad_lines=False)
	#EDA
	if choice == 'EDA':
